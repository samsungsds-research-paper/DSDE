...
from typing import Any, Callable,Optional, Union, Dict, Tuple, List
...
class SequenceGroup:
    ...
    def __init__(self,
                 ...
                 priority: int = 0,
                 draft_size: int = 1,
                 initial_speculative_k: Optional[int] = 0) -> None:
        ...
        self.num_speculative_tokens: Optional[int] = initial_speculative_k
...
class ExecuteModelRequest(
    ...
    # Update k values for scheduler.
    updated_k_values_for_scheduler: Optional[Dict[str, int]] = None
    ...
    def clone(
        ...
        return ExecuteModelRequest(
            ...
            updated_k_values_for_scheduler=self.updated_k_values_for_scheduler.copy() 
            if self.updated_k_values_for_scheduler is not None else None
        )
