...
class SpeculativeConfig:
    ...
    scheduler_mode: Literal["AcceptRateScheduler", "KLScheduler", "KLDHorizonScheduler", "GuardrailScheduler", "HybridScheduler", "AdaEDLScheduler"] | None = field(
        default=None, init=True)
    min_spec_tokens: int = field(default=6, init=True)
    max_spec_tokens: int = field(default=20, init=True)
    dsl_activation_tokens: int = 100
    risk_score_threshold: float = 0.5
    sl_cap_activation: bool = field(default=None)
